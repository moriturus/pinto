...
pub enum Message {
    ...
    DoctorFixed,
    DoctorIssue,
    DoctorKindDanglingDependency,
    DoctorKindDanglingParent,
    DoctorKindDanglingSprint,
    DoctorKindParentCycle,
    DoctorKindDependencyCycle,
    DoctorKindDuplicateId,
    DoctorKindIssuedId,
    DoctorKindInvalidStatus,
    DoctorKindRankAnomaly,
    DoctorKindCollision,
    DoctorKindMalformedRecord,
    DoctorKindFilename,
    ...
    ErrorSprintNotFound,
    ErrorSprintExists,
    ErrorSprintRecordsExist,
    ErrorRetroNotFound,
    ErrorRetroExists,
    ErrorRetroCommandRequired,
    ErrorReviewNotFound,
    ErrorReviewExists,
    ErrorReviewCommandRequired,
    ErrorSprintClosed,
    ...
    ErrorTask,
    ErrorGit,
    ErrorUndoUnavailable,
    ErrorUndoUnsupported,
    ErrorEditorNotSet,
    ErrorEditorLaunch,
    ErrorEditorInvalid,
    ErrorLocked,
    ...
    KanbanSplitTitlePrompt,
    KanbanSplitRelationshipPrompt,
    KanbanSplitBodyPrompt,
    KanbanSplitBodyTextPrompt,
    KanbanSplitTemplatePrompt,
    KanbanSplitDone,
    KanbanSplitInvalidRelationship,
    KanbanSplitInvalidBody,
    KanbanParentPrompt,
    KanbanParentSet,
    KanbanParentCleared,
    KanbanActiveFilter,
...
impl Message {
    const fn id(self) -> &'static str {
        match self {
            ...
            Self::SplitCreated => "split-created",
            Self::NoBacklogItems => "no-backlog-items",
            Self::NoActionableItems => "no-actionable-items",
            Self::Moved => "moved",
            ...
            Self::CreatedRetro => "created-retro",
            Self::UpdatedRetro => "updated-retro",
            Self::CreatedReview => "created-review",
            Self::UpdatedReview => "updated-review",
            Self::AssignedToSprint => "assigned-to-sprint",
            Self::UnassignedFromSprint => "unassigned-from-sprint",
            Self::NoSprints => "no-sprints",
            Self::NoRetros => "no-retros",
            Self::NoReviews => "no-reviews",
            Self::LinkedActionPbis => "linked-action-pbis",
            Self::NoLinkedActionPbis => "no-linked-action-pbis",
            ...
            Self::ImportRefused => "import-refused",
            Self::UndoReverted => "undo-reverted",
            Self::WipLimitExceeded => "wip-limit-exceeded",
            Self::SprintLoadWarning => "sprint-load-warning",
            ...
            Self::DoctorHealthy => "doctor-healthy",
            Self::DoctorIssues => "doctor-issues",
            Self::DoctorFixed => "doctor-fixed",
            Self::DoctorIssue => "doctor-issue",
            Self::DoctorKindDanglingDependency => "doctor-kind-dangling-dependency",
            Self::DoctorKindDanglingParent => "doctor-kind-dangling-parent",
            Self::DoctorKindDanglingSprint => "doctor-kind-dangling-sprint",
            Self::DoctorKindParentCycle => "doctor-kind-parent-cycle",
            Self::DoctorKindDependencyCycle => "doctor-kind-dependency-cycle",
            Self::DoctorKindDuplicateId => "doctor-kind-duplicate-id",
            Self::DoctorKindIssuedId => "doctor-kind-issued-id",
            Self::DoctorKindInvalidStatus => "doctor-kind-invalid-status",
            Self::DoctorKindRankAnomaly => "doctor-kind-rank-anomaly",
            Self::DoctorKindCollision => "doctor-kind-collision",
            Self::DoctorKindMalformedRecord => "doctor-kind-malformed-record",
            Self::DoctorKindFilename => "doctor-kind-filename",
            ...
            Self::ErrorSprintRecordsExist => "error-sprint-records-exist",
            Self::ErrorRetroNotFound => "error-retro-not-found",
            Self::ErrorRetroExists => "error-retro-exists",
            Self::ErrorRetroCommandRequired => "error-retro-command-required",
            Self::ErrorReviewNotFound => "error-review-not-found",
            Self::ErrorReviewExists => "error-review-exists",
            Self::ErrorReviewCommandRequired => "error-review-command-required",
            ...
            Self::ErrorUndoUnavailable => "error-undo-unavailable",
            Self::ErrorUndoUnsupported => "error-undo-unsupported",
            ...
            Self::KanbanSplitTitlePrompt => "kanban-split-title-prompt",
            Self::KanbanSplitRelationshipPrompt => "kanban-split-relationship-prompt",
            Self::KanbanSplitBodyPrompt => "kanban-split-body-prompt",
            Self::KanbanSplitBodyTextPrompt => "kanban-split-body-text-prompt",
            Self::KanbanSplitTemplatePrompt => "kanban-split-template-prompt",
            Self::KanbanSplitDone => "kanban-split-done",
            Self::KanbanSplitInvalidRelationship => "kanban-split-invalid-relationship",
            Self::KanbanSplitInvalidBody => "kanban-split-invalid-body",
...
mod tests {
    ...
    fn every_message_id_has_a_safe_fallback_and_lookup_handles_unknown_ids() {
        ...
        let messages = [
            ...
            Message::NoRetros,
            Message::NoReviews,
            Message::LinkedActionPbis,
            Message::NoLinkedActionPbis,
            ...
            Message::DoctorHealthy,
            Message::DoctorIssues,
            Message::DoctorFixed,
            Message::DoctorIssue,
            Message::DoctorKindDanglingDependency,
            Message::DoctorKindDanglingParent,
            Message::DoctorKindDanglingSprint,
            Message::DoctorKindParentCycle,
            Message::DoctorKindDependencyCycle,
            Message::DoctorKindDuplicateId,
            Message::DoctorKindIssuedId,
            Message::DoctorKindInvalidStatus,
            Message::DoctorKindRankAnomaly,
            Message::DoctorKindCollision,
            Message::DoctorKindMalformedRecord,
            Message::DoctorKindFilename,
            ...
            Message::ErrorRetroNotFound,
            Message::ErrorRetroExists,
            Message::ErrorRetroCommandRequired,
            Message::ErrorReviewNotFound,
            Message::ErrorReviewExists,
            Message::ErrorReviewCommandRequired,
            ...
            Message::ErrorTask,
            Message::ErrorGit,
            Message::ErrorUndoUnavailable,
            Message::ErrorUndoUnsupported,
