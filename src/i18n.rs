...
pub enum Message {
    ...
    ErrorSprintGoalOutcomeRequiresGoal,
    ErrorInvalidSprintTransition,
    ErrorSprintNotFound,
    ErrorSprintExists,
    ErrorSprintRecordsExist,
    ErrorSprintRecordNotFound,
    ErrorSprintRecordExists,
    ErrorSprintRecordCommandRequired,
    ErrorSprintClosed,
    ErrorInvalidSprintPeriod,
    ErrorSprintPeriodIncomplete,
...
impl Message {
    const fn id(self) -> &'static str {
        match self {
            ...
            Self::CreatedSprintRecord => "created-sprint-record",
            Self::UpdatedSprintRecord => "updated-sprint-record",
            Self::AssignedToSprint => "assigned-to-sprint",
            Self::UnassignedFromSprint => "unassigned-from-sprint",
            Self::NoSprints => "no-sprints",
            Self::NoSprintRecords => "no-sprint-records",
            ...
            Self::ErrorSprintGoalOutcomeRequiresGoal => "error-sprint-goal-outcome-requires-goal",
            ...
            Self::ErrorSprintRecordNotFound => "error-sprint-record-not-found",
            Self::ErrorSprintRecordExists => "error-sprint-record-exists",
            Self::ErrorSprintRecordCommandRequired => "error-sprint-record-command-required",
            Self::ErrorSprintClosed => "error-sprint-closed",
            Self::ErrorInvalidSprintPeriod => "error-invalid-sprint-period",
            Self::ErrorSprintPeriodIncomplete => "error-sprint-period-incomplete",
