...
and chore labels; several seeded PBIs demonstrate items with multiple labels.
...
cargo run --manifest-path ../../../Cargo.toml -- edit T-1 -l feature -l frontend -l ux   # replace labels
```
